...
internal fun <P1 : Any, P2 : Any, S> typedPrimaryEntryKey(
    ...
    storedAs: S,
): TypedPrimaryKey2<P1, P2, S> where S : CacheStorage, S : SupportsValueReturn =
...
internal fun <P1 : Any, P2 : Any, P3 : Any, S> typedPrimaryEntryKey(
    ...
    storedAs: S,
): TypedPrimaryKey3<P1, P2, P3, S> where S : CacheStorage, S : SupportsValueReturn =
...
internal fun <P1 : Any, P2 : Any, P3 : Any, P4 : Any, S> typedPrimaryEntryKey(
    ...
    storedAs: S,
): TypedPrimaryKey4<P1, P2, P3, P4, S> where S : CacheStorage, S : SupportsValueReturn =
...
internal fun <P1 : Any, P2 : Any, P3 : Any, P4 : Any, P5 : Any, S> typedPrimaryEntryKey(
    ...
    storedAs: S,
): TypedPrimaryKey5<P1, P2, P3, P4, P5, S> where S : CacheStorage, S : SupportsValueReturn =
...
internal fun <P1 : Any, P2 : Any, P3 : Any, P4 : Any, P5 : Any, P6 : Any, S> typedPrimaryEntryKey(
    ...
    storedAs: S,
): TypedPrimaryKey6<P1, P2, P3, P4, P5, P6, S> where S : CacheStorage, S : SupportsValueReturn =
