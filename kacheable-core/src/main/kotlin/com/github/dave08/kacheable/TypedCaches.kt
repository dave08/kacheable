...
interface CacheDeclaration<R> {
    val name: String
    val serializer: KSerializer<R>
}

interface CacheCall<R> {
    val declaration: CacheDeclaration<R>
    val args: CacheArgs
}

interface Cache0<R> : CacheDeclaration<R> {
    operator fun invoke(): CacheCall<R>
}

interface Cache1<P1 : Any, R> : CacheDeclaration<R> {
    operator fun invoke(p1: P1): CacheCall<R>
}

interface Cache2<P1 : Any, P2 : Any, R> : CacheDeclaration<R> {
    operator fun invoke(p1: P1, p2: P2): CacheCall<R>
}

interface Cache3<P1 : Any, P2 : Any, P3 : Any, R> : CacheDeclaration<R> {
    operator fun invoke(p1: P1, p2: P2, p3: P3): CacheCall<R>
}

interface Cache4<P1 : Any, P2 : Any, P3 : Any, P4 : Any, R> : CacheDeclaration<R> {
    operator fun invoke(p1: P1, p2: P2, p3: P3, p4: P4): CacheCall<R>
}

interface Cache5<P1 : Any, P2 : Any, P3 : Any, P4 : Any, P5 : Any, R> : CacheDeclaration<R> {
    operator fun invoke(p1: P1, p2: P2, p3: P3, p4: P4, p5: P5): CacheCall<R>
}

interface Cache6<P1 : Any, P2 : Any, P3 : Any, P4 : Any, P5 : Any, P6 : Any, R> : CacheDeclaration<R> {
    operator fun invoke(p1: P1, p2: P2, p3: P3, p4: P4, p5: P5, p6: P6): CacheCall<R>
}

interface KeyedCache<K : Any, R> : CacheDeclaration<R> {
    operator fun invoke(key: K): CacheCall<R>
}

@PublishedApi
internal data class SimpleCacheDeclaration<R>(
...
internal data class SimpleCacheCall<R>(
    override val declaration: CacheDeclaration<R>,
    override val args: CacheArgs,
) : CacheCall<R>

inline fun <reified R> cache0(name: String): Cache0<R> {
    val declaration = SimpleCacheDeclaration(name, serializer<R>())
    return object : Cache0<R>, CacheDeclaration<R> by declaration {
...
inline fun <P1 : Any, reified R> cache1(name: String): Cache1<P1, R> {
    val declaration = SimpleCacheDeclaration(name, serializer<R>())
    return object : Cache1<P1, R>, CacheDeclaration<R> by declaration {
...
inline fun <P1 : Any, P2 : Any, reified R> cache2(name: String): Cache2<P1, P2, R> {
    val declaration = SimpleCacheDeclaration(name, serializer<R>())
    return object : Cache2<P1, P2, R>, CacheDeclaration<R> by declaration {
...
inline fun <P1 : Any, P2 : Any, P3 : Any, reified R> cache3(name: String): Cache3<P1, P2, P3, R> {
    val declaration = SimpleCacheDeclaration(name, serializer<R>())
    return object : Cache3<P1, P2, P3, R>, CacheDeclaration<R> by declaration {
...
inline fun <P1 : Any, P2 : Any, P3 : Any, P4 : Any, reified R> cache4(name: String): Cache4<P1, P2, P3, P4, R> {
    val declaration = SimpleCacheDeclaration(name, serializer<R>())
    return object : Cache4<P1, P2, P3, P4, R>, CacheDeclaration<R> by declaration {
...
inline fun <P1 : Any, P2 : Any, P3 : Any, P4 : Any, P5 : Any, reified R> cache5(name: String): Cache5<P1, P2, P3, P4, P5, R> {
    val declaration = SimpleCacheDeclaration(name, serializer<R>())
    return object : Cache5<P1, P2, P3, P4, P5, R>, CacheDeclaration<R> by declaration {
...
inline fun <P1 : Any, P2 : Any, P3 : Any, P4 : Any, P5 : Any, P6 : Any, reified R> cache6(name: String): Cache6<P1, P2, P3, P4, P5, P6, R> {
    val declaration = SimpleCacheDeclaration(name, serializer<R>())
    return object : Cache6<P1, P2, P3, P4, P5, P6, R>, CacheDeclaration<R> by declaration {
...
inline fun <K : Any, reified R> cache(name: String): KeyedCache<K, R> {
    val declaration = SimpleCacheDeclaration(name, serializer<R>())
    return object : KeyedCache<K, R>, CacheDeclaration<R> by declaration {
...
suspend fun Kacheable.invalidate(vararg calls: CacheCall<*>) {
    invalidate(*calls.map { it.declaration.name to it.args.toParamsArray().toList() }.toTypedArray()) {}
}

suspend fun <T> Kacheable.invalidate(vararg calls: CacheCall<*>, block: suspend () -> T): T {
    return invalidate(*calls.map { it.declaration.name to it.args.toParamsArray().toList() }.toTypedArray(), block = block)
}
